...
const tonConnectUI = new TonConnectUI({
    manifestUrl: "https://codetin.github.io/tma-game/tonconnect-manifest.json",
    buttonRootId: "wallet",
});
...
function call() {
    ...
    WebApp.openTelegramLink(
        "https://t.me/share/url?text=%F0%9F%9A%80%F0%9F%9A%80%F0%9F%9A%80%E5%BC%80%E5%A7%8B%E6%B5%8B%E8%AF%95%E6%88%91%E7%9A%84%E9%93%BE%E6%8E%A5%E5%90%A7%0A&url=https://t.me/teletest3721_bot/game?startapp=3JRL8T"
    );
}
...
try {
    const encode_data = btoa(init_data);
    let url = `https://api.metalbros.io/login?initdata=${encode_data}`;
    fetch(url, {
        method: "GET",
        headers: {
